...
<html>
  ...
  <body>
    ...
    <div class="main" id="main">
        <button class="the_cross" type="button" id="the_cross">
        ...
        <div class="short_background" style="position: absolute; width: 160px; height: 20px; background: linear-gradient(45deg, #006363, #63f8f8); margin-left: 8.9px; margin-top: 4.8px; ">
            <div class="short" style="position: absolute; width: 150px; height: 20px; font-family: sans-serif; font-weight: 600; font-size: 16px; line-height: 25px; margin-left: 7px; color: white; top: -2px">Краткий пересказ</div>
        </div>
...
`;
    ...
    if (switch_parameter) {
        ...
        const closeButton = document.getElementById("the_cross");
        const mainDiv = document.getElementById("main");
        const summary1 = document.getElementById("summary1351");
        const summary2 = document.getElementById("summary2351");

        button.addEventListener("click", () => {
            mainDiv.style.display = mainDiv.style.display === "none" || !mainDiv.style.display ? "block" : "none";
        });
        ...
        button.addEventListener("click", async () => {
            ...
            try {
                ...
                if (dubbleText) {
                    animateText(summary1, dubbleText.short_message || "Ошибка выполнения");
                    animateText(summary2, dubbleText.message || "Ошибка выполнения");
                } else {
                    animateText(summary1, "Ошибка выполнения");
                    animateText(summary2, "Ошибка выполнения");
...
/**
 * Анимация текста по одной букве
 */
